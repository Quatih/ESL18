...
/* XXDelay is model specific and therefore implemented in IO_Pan.cpp */
/* XXInitialValue is model specific and therefore implemented in IO_Pan.cpp */
...
/* XXStopSimulation is implemented in IO_Pan.cpp */
