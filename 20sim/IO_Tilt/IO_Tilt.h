...
/* This file describes the model functions
   ...
   The model itself is the IO_Tilt.cpp file
*/
#ifndef IO_Tilt_H
#define IO_Tilt_H
...
class IO_Tilt: virtual public Submodel20sim
{
	public:
		enum stateflags_IO_Tilt {initialrun, mainrun, finished};
		 ...
		 * IO_Tilt destructor
		 */
		virtual ~IO_Tilt(void);

		/**
		 * IO_Tilt Initialization of the model and calculation of the values for the start time t
