...
/* This file describes the model functions
   ...
   The model itself is the JIWYController.cpp file
*/
#ifndef JIWYController_H
#define JIWYController_H
...
class JIWYController: virtual public Submodel20sim
{
	public:
		enum stateflags_JIWYController {initialrun, mainrun, finished};

		/**
		 * JIWYController constructor
		 */
		JIWYController(void);

		/**
		 * JIWYController destructor
		 */
		virtual ~JIWYController(void);

		/**
		 * JIWYController Initialization of the model and calculation of the values for the start time t
		...
		stateflags_JIWYController state;
