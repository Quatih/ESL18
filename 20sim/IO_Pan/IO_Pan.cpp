...
void IO_Pan::CopyInputsToVariables (XXDouble *u)
{
...
void IO_Pan::CopyVariablesToOutputs (XXDouble *y)
{
...
void IO_Pan::Reset(XXDouble starttime)
{
...
void IO_Pan::Initialize (XXDouble *u, XXDouble *y, XXDouble t)
{
...
void IO_Pan::Calculate (XXDouble *u, XXDouble *y /*, XXDouble t*/)
{
	switch (state)
	{
...
void IO_Pan::Terminate (XXDouble *u, XXDouble *y /*, XXDouble t */)
{
	/* copy the inputs */
	CopyInputsToVariables (u);
 ...
 */
void IO_Pan::CalculateInitial (void)
{
 ...
 */
void IO_Pan::CalculateStatic (void)
{
 ...
 */
void IO_Pan::CalculateInput (void)
{
 ...
 */
void IO_Pan::CalculateDynamic (void)
{
 ...
 */
void IO_Pan::CalculateOutput (void)
{
 ...
 * are performed
 */
void IO_Pan::CalculateFinal (void)
{
...
bool IO_Pan::SetFinishTime(XXDouble newtime)
{
