...
/* XXDelay is model specific and therefore implemented in JIWYController.cpp */
/* XXInitialValue is model specific and therefore implemented in JIWYController.cpp */
...
/* XXStopSimulation is implemented in JIWYController.cpp */
