...
/* This file describes the model functions
   ...
   The model itself is the IO_Pan.cpp file
*/
#ifndef IO_Pan_H
#define IO_Pan_H
...
class IO_Pan: virtual public Submodel20sim
{
	public:
		enum stateflags_IO_Pan {initialrun, mainrun, finished};
		...
		/**
		 * IO_Pan Initialization of the model and calculation of the values for the start time t
