...
/* XXDelay is model specific and therefore implemented in IO_Tilt.cpp */
/* XXInitialValue is model specific and therefore implemented in IO_Tilt.cpp */
...
/* XXStopSimulation is implemented in IO_Tilt.cpp */
