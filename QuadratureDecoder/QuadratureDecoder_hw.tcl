...
add_fileset_file esl_demonstrator.vhd VHDL PATH esl_demonstrator.vhd TOP_LEVEL_FILE
add_fileset_file QuadratureDecoder.vhd VHDL PATH QuadratureDecoder.vhd
...
add_interface_port conduit_end inputs export Input 2
