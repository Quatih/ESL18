...
SOPCINFO_FILE := $(ABS_BSP_ROOT_DIR)/../../Quad_Dec.sopcinfo
...
# setting SOPC_SYSID_BASE_ADDRESS is 0x11c40
SOPC_SYSID_FLAG += --sidp=0x11c40
ELF_PATCH_FLAG  += --sidp 0x11c40

# The SOPC Timestamp 
# setting SOPC_TIMESTAMP is 1529059747
SOPC_SYSID_FLAG += --timestamp=1529059747
ELF_PATCH_FLAG  += --timestamp 1529059747
